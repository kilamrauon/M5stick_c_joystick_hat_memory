...
niveau_en_cours = M5TextBox(59, 144, "Text", lcd.FONT_Default, 0xFFFFFF, rotate=0)
rebours = M5TextBox(20, 55, "Text", lcd.FONT_Default, 0xFFFFFF, rotate=0)
label4 = M5TextBox(20, 99, "Text", lcd.FONT_DejaVu40, 0xFFFFFF, rotate=0)
label0 = M5TextBox(0, 41, "suite dans : ", lcd.FONT_DefaultSmall, 0xFFFFFF, rotate=0)
action_a_effectuer = M5TextBox(0, 72, "Text", lcd.FONT_DefaultSmall, 0xFFFFFF, rotate=0)
